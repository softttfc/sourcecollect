...
class Spider(Spider):
    ...
    def homeContent(self,filter):
        ...
        regions={"key":"region","name":"地区","value":[{"n":"全部","v":""},{"n":"国产剧","v":"t-zuvois"},{"n":"欧美剧","v":"t-3m25gq"},{"n":"日剧","v":"t-ue8oql"},{"n":"港台剧","v":"hktwdrama"},{"n":"韩剧","v":"kdrama"},{"n":"泰剧","v":"thaidrama"},{"n":"海外剧","v":"globaldrama"}]}
        for tid in ["t-5jxcit","t-k1gwip","t-eb9c3c","t-hebbu9","t-k3onqj","t-zuvois","t-3m25gq","t-ue8oql","hktwdrama","kdrama","thaidrama","globaldrama"]:
